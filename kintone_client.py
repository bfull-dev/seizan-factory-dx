  ...
  "items": [
    {
      ...
      "単位": "個/枚/kg/L/式 など",
      "購入単価": 単価（数値、不明なら0）,
      "内税": true または false（税込み価格で記載されている場合はtrue、税抜き価格の場合はfalse）,
...
注意事項：
- 書類に「税抜」「税別」「本体価格」と明記されていれば内税=false、購入単価にその価格を入れること
- 書類に「税込」「税込価格」と明記されている、または税抜価格が読み取れない場合は内税=true、購入単価に税込価格をそのまま入れること（÷1.1の換算は不要）
- AmazonなどECサイトの請求書は通常税込表記のため内税=trueとすること
